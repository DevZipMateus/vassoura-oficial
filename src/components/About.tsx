...
const About = () => {
  return <section id="sobre" className="section bg-white">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          animationDelay: '0.8s'
            ...
            <div className="relative">
              ...
              <img alt="Produtos de limpeza organizados - Vassouras Nova Del Rei" className="relative z-10 rounded-lg shadow-lg w-full object-cover h-[400px]" src="https://vaabpicspdbolvutnscp.supabase.co/storage/v1/object/sign/site_personalizacoes/midias/1752593068753_2_screenshot_20250715_121529_instagram.jpg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV80YTMyOTM2My1kZjM3LTRkMTAtOTliNC01NGRjNzUwNWQ4NWMiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJzaXRlX3BlcnNvbmFsaXphY29lcy9taWRpYXMvMTc1MjU5MzA2ODc1M18yX3NjcmVlbnNob3RfMjAyNTA3MTVfMTIxNTI5X2luc3RhZ3JhbS5qcGciLCJpYXQiOjE3NTI2MDM1MDEsImV4cCI6MTc1MjYwNzEwMX0.6q60Er60Xc0fAuq-0Z4E7LcH3LpZOnwwJE7FKnjqDcg" />
